#!/usr/bin/env python3
"""
NeoX v4.2.1 – Web Search + Model Icons Edition
...
from neox.services.helpers import (
    process_attachment,
    short_id,
    get_initials,
    repair_json,
...
def load_settings() -> dict:
    ...
    default = {
        ...
        "response_mode": "voting",  # voting or collaborative
    }
...
class HowToManualDialog(QtWidgets.QDialog):
    """Comprehensive how-to manual for NeoX"""
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("""
            QWidget { background-color: #202123; color: #ECECF1; font-family: Segoe UI; }
            QTextEdit { background-color: #343541; border-radius: 10px; padding: 10px; }
            QLineEdit { background-color: #40414F; border-radius: 10px; padding: 8px; }
            QPushButton {
                background-color: #10A37F;
                border-radius: 10px;
                padding: 8px;
        ...
        self.setWindowTitle("📖 NeoX - How to Use")
    ...
    def setup_ui(self):
        ...
        # Title
        title = QtWidgets.QLabel("🏛️ NEOX USER MANUAL")
        ...
        <h2>🎯 What is NeoX?</h2>
        <p>NeoX orchestrates multiple AI models to collaborate on answering your questions. Models debate, vote, and compete to provide the best answer.</p>
        ...
        <p><b>Step 2: Configure in NeoX</b></p>
        <ol>
...
class DiscoveryWorker(QThread):
    ...
    def __init__(self, lm_url: str, ollama_url: str, lm_enabled: bool, ollama_enabled: bool):
        super().__init__()
        self.memory_manager = NeoXMemoryManager()
        self.lm_url = lm_url
...
class ServerConfigDialog(QtWidgets.QDialog):
    ...
    def setup_ui(self):
        ...
        # Response Mode
        form.addRow(QtWidgets.QLabel("<b>Response Mode</b>"))
        self.response_mode = QtWidgets.QComboBox()
        self.response_mode.addItems(["Voting", "Collaborative"])
        form.addRow("Mode:", self.response_mode)
    ...
    def load_current(self):
        ...
        self.response_mode.setCurrentText(settings.get("response_mode", "voting").capitalize())
    ...
    def save_settings(self):
        save_settings({
            ...
            "response_mode": self.response_mode.currentText().lower(),
        })
        global settings
        settings = load_settings()
...
class NeoXCouncilWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("🐙 NeoX v4.2 – Web Search + Icons + Agentic Debate")
        self.resize(1800, 1000)
        
        self.models = []
        self.model_list_items = {}
        self.model_cards = {}
        self.model_memories = {}  # per-model memory
        self.model_colors = {}
        self.model_backends = {}
    ...
    def show_about(self):
        ...
        """
        QtWidgets.QMessageBox.about(self, "About NeoX", about_text)
...
def main():
    ...
    app.setApplicationName("NeoX")
    
    if THEME_AVAILABLE:
        theme = settings.get("theme", "dark")
        apply_theme(theme, app)
    
    win = NeoXCouncilWindow()
    win.show()
    sys.exit(app.exec())
